...
static TextTheme lightTextTheme = TextTheme(
  ...
  headlineSmall: GoogleFonts.poppins (fontSize: 14.0, fontWeight: FontWeight.w600, color: tDarkColor), 
...
static TextTheme darkTextTheme= TextTheme(
  ...
  headlineSmall: GoogleFonts.poppins (fontSize: 14.0, fontWeight: FontWeight.w600, color: tWhiteColor), 
